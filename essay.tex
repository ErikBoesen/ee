...
$$\frac{\partial{C}}{\partial{\omega_h}}=\frac{ \partial{C} }{ \partial{\mathcal{O}_h} }
                                         \frac{ \partial{\mathcal{O}_h} }{ \partial{z_h} }
                                         \frac{ \partial{z_h} }{ \partial{\omega_h} }$$

\todo{I DON'T THINK WE WANT H}
Where $h$ represents this final hidden layer's index and $z_h$ the weighted sum, plus the bias, of the neuron's inputs before application of the activation function.
