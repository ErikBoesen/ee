...
We can then expand this function to find the total error of the network during one epoch (training iteration) as follows [citation needed]:
$$E=\frac{1}{2}\sum_n(t_n-\mathcal{O}_n)^2$$
