...
Each neuron, on its own, simply sums the output values of each neuron in the previous layer (and, typically, passes the result through the sigmoid scaling function to bring the output into the range $(0, 1)$ or $(-1, 1)$).
...
Each network contains three types of layers:
\begin{itemize}
\item{Input Layer - A vector of input values.}
